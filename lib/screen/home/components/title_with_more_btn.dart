...
class TitleWithMoreBtn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: kDeafultPadding),
      child: Row(
        children: <Widget> [
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        children: <Widget> [
          Padding(
            padding: const EdgeInsets.only(left: kDeafultPadding / 4),
            child: Text(text
              ,style:
          ...
          Positioned(
            ...
            child: Container(
              margin: EdgeInsets.only(right: kDeafultPadding / 4),
              height: 7,color: Colors.brown.withOpacity(0.2),
            ),
          )
        ]
        ),
